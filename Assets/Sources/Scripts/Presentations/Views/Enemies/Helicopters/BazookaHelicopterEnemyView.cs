...
{
    public class BazookaHelicopterEnemyView : MovingEnemyViewBase, IBazookaHelicopterEnemyView
    {
        [SerializeField] private BazookaHelicopterEnemyAnimation _enemyAnimation;
